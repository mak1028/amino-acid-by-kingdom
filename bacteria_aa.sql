select * from codons where Kingdom='arc'
...
insert into vertebrates(phe, leu, ser, ile, val, pro, thr, ala, tyr, his, gln, asn, lys, asp, glu, cys, arg, gly, stop_codon, met, trp)
